! function(t) {
	"function" == typeof define && define.amd ? define(["jquery", "codemirror"], t) : t(window.jQuery, window
		.CodeMirror)
}(function(t, e) {
	"function" != typeof Array.prototype.reduce && (Array.prototype.reduce = function(t, e) {
		var n, a, o = this.length >>> 0,
			i = !1;
		for (1 < arguments.length && (a = e, i = !0), n = 0; o > n; ++n) this.hasOwnProperty(n) && (i ? a =
			t(a, this[n], n, this) : (a = this[n], i = !0));
	...
	var n = {
			...
			var e = !!document.createRange,
				n = function(t, e) {
					...
					for (n = 0; n < s.length; n++)
						...
						for (var f = u.text.replace(/[\r\n]/g, "").length; f > c.nodeValue.length && c.nextSibling;)
							f -= c.nodeValue.length, c = c.nextSibling; {
							c.nodeValue
						}
						e && c.nextSibling && i.isText(c.nextSibling) && f === c.nodeValue.length && (f -= c
							.nodeValue.length, c = c.nextSibling), r = c, n = f
					}
					return {
						cont: r,
						offset: n
				...
				r = function(t) {
					var e = function(t, n) {
						...
						r = e(t.cont, t.offset);
					return n.moveToElementText(r.cont), n.collapse(r.collapseToStart), n.moveStart("character", r
						.offset), n
				},
				l = function(n, l, s, d) {
					...
					this.isOnEditable = u(i.isEditable), this.isOnList = u(i.isList), this.isOnAnchor = u(i
						.isAnchor), this.isCollapsed = function() {
						return n === s && l === d
		...
		s = function() {
			this.stylePara = function(e, n) {
				...
				if (o["font-size"] = parseInt(o["font-size"]), o["font-bold"] = document.queryCommandState(
						"bold") ? "bold" : "normal", o["font-italic"] = document.queryCommandState("italic") ?
					"italic" : "normal", o["font-underline"] = document.queryCommandState("underline") ?
					"underline" : "normal", e.isOnList()) {
				...
				return o.image = i.isImg(n) && n, o.anchor = e.isOnAnchor() && i.ancestor(e.sc, i.isAnchor), o
					.aAncestor = i.listAncestor(e.sc, i.isEditable), o
			}
		},
		d = function() {
			var t = [],
		...
		c = function() {
			...
			for (var a = this.recordUndo = function(t) {
				...
				}, o = ["bold", "italic", "underline", "strikethrough", "justifyLeft", "justifyCenter",
					"justifyRight", "justifyFull", "insertOrderedList", "insertUnorderedList", "indent",
					"outdent", "formatBlock", "removeFormat", "backColor", "foreColor", "insertHorizontalRule"
				], d = 0, c = o.length; c > d; d++) this[o[d]] = function(t) {
				return function(e, n) {
			...
			this.insertImage = function(e, n) {
				...
				if (i && 11 === i[2].length) {
					var v = i[2];
					a = t("<iframe>").attr("src", "http://www.youtube.com/embed/" + v).attr("width", "640")
						.attr("height", "360")
				} else s && s[0].length > 0 ? a = t("<iframe>").attr("src", s[0] + "/embed/").attr("width",
						"612").attr("height", "710").attr("scrolling", "no").attr("allowtransparency", "true") :
					c && c[0].length > 0 ? a = t("<iframe>").attr("src", c[0] + "/embed/simple").attr("width",
						"600").attr("height", "600").attr("class", "vine-embed") : f && f[3].length > 0 ? a = t(
						"<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("src",
						"//player.vimeo.com/video/" + f[3]).attr("width", "640").attr("height", "360") : b && b[
						2].length > 0 && (a = t("<iframe>").attr("src",
						"http://www.dailymotion.com/embed/video/" + b[2]).attr("width", "640").attr(
						"height", "360"));
				...
				a(t), document.execCommand("fontSize", !1, 3), n.bFF ? t.find("font[size=3]").removeAttr("size")
					.css("font-size", e + "px") : t.find("span").filter(function() {
				...
				o({
					...
					l.select(), a(e);
					var i;
					if (i = -1 !== o.indexOf("@") ? -1 !== o.indexOf(":") ? o : "mailto:" + o : -1 !== o
						.indexOf("://") ? o : "http://" + o, n.bMSIE && l.isCollapsed()) {
				...
				var n = JSON.parse(e),
					o = n.foreColor,
					i = n.backColor;
				a(t), o && document.execCommand("foreColor", !1, o), i && document.execCommand("backColor", !1,
					i)
			}, this.insertTable = function(e, o) {
				a(e);
				for (var i, l = o.split("x"), s = l[0], d = l[1], c = [], u = n.bMSIE ? "&nbsp;" : "<br/>", f =
						0; s > f; f++) c.push("<td>" + u + "</td>");
				i = c.join("");
		...
		b = function() {
			...
			this.showImageDialog = function(n, a, o) {
				...
				i.on("shown.bs.modal", function() {
					...
					r.off("change"), i.off("shown.bs.modal hidden.bs.modal"), l.off("keyup"), s.off(
						"click")
				}).modal("show")
		...
		v = function() {
			var a = new c,
				...
				g = function(t) {
					...
					if (i === v.TAB && l.editable().data("tabsize")) a.tab(l.editable());
						...
						if (!e || i !== v.ENTER) return void((i === v.BACKSPACE || i === v.ENTER || i === v
							.SPACE) && a.recordUndo(m(t.target).editable()));
				...
				x = function(e) {
					if (i.isControlSizing(e.target)) {
						...
						u.on("mousemove", function(t) {
							...
							}), h.data("ratio") || h.data("ratio", h.height() / h.width()), a.recordUndo(c), e
				...
				S = function(r) {
					...
					if (l.length > 0) {
						...
						if (a[c] && (g.trigger("focus"), a[c](g, u, s)), -1 !== t.inArray(c, ["backColor",
								"foreColor"
							...
							} else n.bCodeMirror && y.data("cmEditor").toTextArea(), g.html(y.val() || i.emptyPara),
								g.height(g.data("optionHeight") ? y.height() : "auto"), o.enable(b), g.focus();
				...
				I = function(e) {
					...
					t(document).on("dragenter", function(t) {
						...
						i || 0 !== n.length || (e.editor.addClass("dragover"), a.width(e.editor.width()), a
							.height(e.editor.height()), o.text("Drag Image Here")), n = n.add(t.target)
			...
			this.attach = function(t, e) {
				t.editable.on("keydown", g), t.editable.on("mousedown", k), t.editable.on("keyup mouseup", w), t
					.editable.on("scroll", C), I(t), t.handle.on("mousedown", x), t.toolbar.on("click", S), t
					.popover.on("click", S), t.toolbar.on("mousedown", F), t.popover.on("mousedown", F), t
					.statusbar.on("mousedown", E);
				var n = t.toolbar,
				...
				o.on("mousemove", z), t.editable.on("blur", function() {
					...
					}), e.onfocus && t.editable.focus(e.onfocus), e.onblur && t.editable.blur(e.onblur), e
					.onkeyup && t.editable.keyup(e.onkeyup), e.onkeydown && t.editable.keydown(e.onkeydown), t
		...
		m = function() {
			...
			e = {
					picture: function(t) {
						return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + t
							.image.image +
							'" data-event="showImageDialog" tabindex="-1"><i class="editor-picture icon-picture"></i></button>'
					},
					link: function(t) {
						return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + t.link
							.link +
					...
					style: function(t) {
						return '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="' +
							...
							t.style.normal +
							'</a></li><li><a data-event="formatBlock" data-value="blockquote"><blockquote>' + t
							.style.blockquote +
							'</blockquote></a></li><li><a data-event="formatBlock" data-value="pre">' + t.style
							.pre + '</a></li><li><a data-event="formatBlock" data-value="h1"><h1>' + t.style
							.h1 + '</h1></a></li><li><a data-event="formatBlock" data-value="h2"><h2>' + t.style
							.h2 + '</h2></a></li><li><a data-event="formatBlock" data-value="h3"><h3>' + t.style
							.h3 + '</h3></a></li><li><a data-event="formatBlock" data-value="h4"><h4>' + t.style
							.h4 + '</h4></a></li><li><a data-event="formatBlock" data-value="h5"><h5>' + t.style
							.h5 + '</h5></a></li><li><a data-event="formatBlock" data-value="h6"><h6>' + t.style
							.h6 + "</h6></a></li></ul>"
					},
					fontsize: function(t) {
					...
					color: function(t) {
						return '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="' +
							...
							t.color.transparent + '">' + t.color.setTransparent +
							...
							t.color.reset + '">' + t.color.resetToDefault +
							'</div><div class="note-color-palette" data-target-event="foreColor"></div></div></li></ul>'
					},
					bold: function(t) {
						return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + t.font
							.bold +
			...
			var s = function(t) {
					return '<table class="note-shortcut"><thead><tr><th></th><th>' + t.shortcut.textFormatting +
						"</th></tr></thead><tbody><tr><td>⌘ + B</td><td>" + t.font.bold +
						"</td></tr><tr><td>⌘ + I</td><td>" + t.font.italic + "</td></tr><tr><td>⌘ + U</td><td>" + t
						.font.underline + "</td></tr><tr><td>⌘ + ⇧ + S</td><td>" + t.font.strike +
						"</td></tr><tr><td>⌘ + \\</td><td>" + t.font.clear + "</td></tr></tr></tbody></table>"
				},
				c = function(t) {
					return '<table class="note-shortcut"><thead><tr><th></th><th>' + t.shortcut.action +
						"</th></tr></thead><tbody><tr><td>⌘ + Z</td><td>" + t.history.undo +
						"</td></tr><tr><td>⌘ + ⇧ + Z</td><td>" + t.history.redo +
						"</td></tr><tr><td>⌘ + ]</td><td>" + t.paragraph.indent +
						"</td></tr><tr><td>⌘ + [</td><td>" + t.paragraph.outdent +
						"</td></tr><tr><td>⌘ + K</td><td>" + t.link.insert +
						"</td></tr><tr><td>⌘ + ENTER</td><td>" + t.hr.insert + "</td></tr></tbody></table>"
				},
				u = function(t) {
					return '<table class="note-shortcut"><thead><tr><th></th><th>' + t.shortcut
						.paragraphFormatting + "</th></tr></thead><tbody><tr><td>⌘ + ⇧ + L</td><td>" + t.paragraph
						.left + "</td></tr><tr><td>⌘ + ⇧ + E</td><td>" + t.paragraph.center +
						"</td></tr><tr><td>⌘ + ⇧ + R</td><td>" + t.paragraph.right +
						"</td></tr><tr><td>⌘ + ⇧ + J</td><td>" + t.paragraph.justify +
						"</td></tr><tr><td>⌘ + ⇧ + NUM7</td><td>" + t.lists.ordered +
						"</td></tr><tr><td>⌘ + ⇧ + NUM8</td><td>" + t.lists.unordered + "</td></tr></tbody></table>"
				},
				f = function(t) {
					return '<table class="note-shortcut"><thead><tr><th></th><th>' + t.shortcut.documentStyle +
						"</th></tr></thead><tbody><tr><td>⌘ + NUM0</td><td>" + t.style.normal +
						"</td></tr><tr><td>⌘ + NUM1</td><td>" + t.style.h1 + "</td></tr><tr><td>⌘ + NUM2</td><td>" +
						t.style.h2 + "</td></tr><tr><td>⌘ + NUM3</td><td>" + t.style.h3 +
						"</td></tr><tr><td>⌘ + NUM4</td><td>" + t.style.h4 + "</td></tr><tr><td>⌘ + NUM5</td><td>" +
						t.style.h5 + "</td></tr><tr><td>⌘ + NUM6</td><td>" + t.style.h6 +
						"</td></tr></tbody></table>"
				},
				h = function(t) {
					return '<table class="note-shortcut-layout"><tbody><tr><td>' + c(t) + "</td><td>" + s(t) +
						"</td></tr><tr><td>" + f(t) + "</td><td>" + u(t) + "</td></tr></tbody></table>"
				},
				b = function(t) {
					return t.replace(/⌘/g, "Ctrl").replace(/⇧/g, "Shift")
				};
			r = function(t) {
					return '<div class="note-dialog"><div class="note-image-dialog modal" aria-hidden="false"><div class="modal-dialog animated bounceIn"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">×</button><h4 class="modal-title">' +
						t.image.insert +
						'</h4></div><div class="modal-body"><div class="row-fluid"><div class="m-b-5">' + t.image
						.selectFromFiles +
						...
						t.video.insert +
						'</h4></div><div class="modal-body"><div class="row-fluid"><div class="form-group"><label>' +
						t.video.url + '</label>&nbsp;<small class="text-muted">' + t.video.providers +
						...
						t.shortcut.close + '</a><div class="title">' + t.shortcut.shortcuts + "</div>" + (n.bMac ?
							h(t) : b(h(t))) +
			...
			var v = function(e, a) {
				...
				g = function(e) {
					e.find(".note-color-palette").each(function() {
						for (var e = t(this), n = e.attr("data-target-event"), a = [], o = 0, i = m
							.length; i > o; o++) {
							for (var r = m[o], l = [], s = 0, d = r.length; d > s; s++) {
								var c = r[s];
								l.push(['<button type="button" class="note-color-btn" style="background-color:',
									c, ';" data-event="', n, '" data-value="', c, '" title="', c,
			...
			this.createLayout = function(n, s) {
				...
				if (!n.next().hasClass("note-editor")) {
					...
					b.data("options", s), c > 0 && t('<div class="note-statusbar">' + l + "</div>").prependTo(
					b);
					var m = t('<div class="note-editable overflow" contentEditable="true"></div>').prependTo(b);
					c && (m.height(c), m.data("optionHeight", c)), u && m.data("tabsize", u), m.html(i.html(
						n) || i.emptyPara), m.data("NoteHistory", new d), t(
						'<textarea class="note-codable"></textarea>').prependTo(b), setTimeout(function() {
					...
					A.find("button.close, a.modal-close").click(function() {
						...
						}), t('<div class="note-dropzone"><div class="note-dropzone-message"></div></div>')
						.prependTo(b), b.insertAfter(n), n.hide()
				}
			};
		...
		code: function(e) {
			if (void 0 === e) {
				...
				if (o && o.editable) {
					...
					return i && n.bCodeMirror && o.codable.data("cmEditor").save(), i ? o.codable
					.val() : o.editable.html()
				}
				return a.html()
			}
